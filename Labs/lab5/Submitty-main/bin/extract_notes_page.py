...
if not os.path.isdir(submission_dir):
    print(f"Could not find submission directory {}"{submission_dir})

if not os.path.isdir(result_dir):
    print(f"Could not find result directory {}"{result_dir})
